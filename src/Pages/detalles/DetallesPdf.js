	...
	<div class="invoice_wrap">
		<div class="invoice-container">
			<div class="invoice-content-wrap" id="download_section">
				...
				<header class="invoice-header text-invoice content-min-width" id="invo_header">
					<div class="invoice-logo-content">
						<div class="invoice-logo">
							<img src="../../logo-mediano.png" alt="logo"/>
					...
					<div class="invoice-header-contact">
						...
						<div class="invo-cont-wrap">
							...
							<div class="invo-social-name">
								<a href="mailto:contact@invoice.com" class="invo-hedaer-mail inter-400">sales@mundiflora.com</a>
							</div>
						</div>
					</div>
				</header>
				...
				<div class="agency-service-content" id="agency_service">
					<div class="container">
						...
						<div class="invoice-owner-conte-wrap">
							<div class="invo-to-wrap">
								<div class="invoice-to-content">
									...
									<h1 class="invo-to-owner inter-700 md-lg-font">Client name</h1>
									<div class="invo-owner-address medium-font inter-400 mtb-0">121 E Parkview St, IN 45240<br/> Toronto, Ontario<br/> Canada</div>
								</div>
							</div>
							<div class="invo-pay-to-wrap">
								<div class="invoice-pay-content">
									<p class="invo-to inter-700 medium-font mtb-0">Ship To:</p>
									<h2 class="invo-to-owner inter-700 md-lg-font">Client name</h2>
									<div class="invo-owner-address medium-font inter-400 mtb-0">4510 E Dolphine St, IN 3526<br/> Hills Road, New York<br/> United States</div>
								</div>
							</div>
						</div>
							...
							<table class="invoice-table">
								...
								<tbody class="invo-tb-body">
									<tr class="invo-tb-row">
										<td class="invo-tb-data">Anthurium warocqueanum medium</td>
										<td class="invo-tb-data">2</td>
										<td class="invo-tb-data">M:2-Cue ; I:2A</td>
										<td class="invo-tb-data total-data">2</td>
									</tr>
									<tr class="invo-tb-row">
										<td class="invo-tb-data">Caladium smaragdinum</td>
										<td class="invo-tb-data">2</td>
										<td class="invo-tb-data">M:3-Cue ; I:5B</td>
										<td class="invo-tb-data total-data">2</td>
									</tr>
									<tr class="invo-tb-row">
										<td class="invo-tb-data">Philodendron heterocraspedon</td>
										<td class="invo-tb-data">1</td>
										<td class="invo-tb-data">M:2-Pang ; I:9C</td>
										<td class="invo-tb-data total-data">1</td>
									</tr>
									<tr class="invo-tb-row">
										<td class="invo-tb-data">Philodendron melanochrysum</td>
										<td class="invo-tb-data">3</td>
										<td class="invo-tb-data">M:4-Pang ; I:1A</td>
										<td class="invo-tb-data total-data">3</td>
									</tr>
								</tbody>
							</table>
						</div>
							...
							{/* <div class="invo-add-info-content">
								...
								<p class="add-info-desc inter-400 mtb-0">
									*The payments can be done by PayPal to sales@mundiflora.com PayPal fee is 4%.
								    ...
								    <div class="add-info-desc inter-400 mtb-0">
